...
10.2.sec=Except with regard to breaches of Article {7.Xnum} (Confidential Information), IN NO EVENT WILL PROVIDER BE LIABLE FOR LOST PROFITS OR LOSS OF BUSINESS OR FOR ANY CONSEQUENTIAL, INDIRECT, SPECIAL, INCIDENTAL, OR PUNITIVE DAMAGES ARISING OUT OF OR RELATED TO THIS AGREEMENT.
...
11.3.sec=Upon termination of this Agreement, Customer shall cease all use of the SaaS and delete, destroy, or return all copies of the Documentation in its possession or control. The following provisions will survive termination or expiration of this Agreement: (a) any obligation of Customer to pay fees incurred before termination; (b) Articles and Sections {6.Xnum} (IP & Feedback), {7.Xnum} (Confidential Information), {8.2.Xnum} (Warranty Disclaimers), {9.Xnum} (Indemnification), and {10.Xnum} (Limitation of Liability); and (c) any other provision of this Agreement that must survive to fulfill its essential purpose.
